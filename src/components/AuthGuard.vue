...
const allowedRoutes = ['login', 'register','registration-submitted','home','not_found', 'verify']
...
router.beforeEach(async (to, from) => {
  ...
  if (user?.value && userStore?.getCSRFHeader() && (redirectIfLogged.includes(to.name as string))) {
